...
angular.module("website.core.settings", ["ng"]), angular.module("website.core.dependency", ["website.core.settings"]), angular.module("website", ["core.library.jsonrpc", "website.core", "website.widgets", "website.plugins", "website.moto_link"]).run(["jsonrpc", function (a) {
    ...
    var h = {}, i = angular.element("head").get(0), j = angular.element("body").get(0), k = {
        en: "en_US",
        de: "de_DE",
        ru: "ru_RU"
    }, l = {};
    l = {
        ...
        facebook: {
            ...
            params: {version: "v2.4", xfbml: "1", appId: ""},
            setParams: function (a) {
                for (var b in a)a.hasOwnProperty(b) && this.setParam(b, a[b]);
                return this
            },
    ...
    angular.element('[data-action="lightbox"].moto-link').magnificPopup({type: "image"}), angular.element("body").delegate(".moto-link", "click", function (a) {
...
}), angular.module("website.widget.contact_form", ["core.library.jsonrpc", "angularFileUpload"]).config(function () {
}).run(function () {
    ...
    if (a.message = {}, a.placeholder = {}, a.hash = "", a.attachments = [], a.attachment = {}, i.length)for (var k = 0, l = i.length; l > k; k++)g = angular.element(i[k]), h = g.attr("name"), h && (a.message[h] = a.message[h] || "", a.placeholder[h] = g.attr("placeholder") || h);
        ...
        restrict: "A", priority: 450, link: function (a, b, c) {
            ...
            d = b.justifiedGallery({
                ...
                b.magnificPopup({
                    delegate: "a",
                    type: "image",
                    gallery: {enabled: !0, preload: [5, 10]},
                    image: {
                        titleSrc: function (a) {
    ...
    if (a.listId = "", a.message = {}, a.emailSent = !1, a.triedToSend = !1, a.emailError = !1, a.isSubscribed = !1, h.length)for (var j = 0, k = h.length; k > j; j++)f = angular.element(h[j]), g = f.attr("name"), g && (a.message[g] = a.message[g] || "");
    a.validateEmailOnBlur = function () {
    ...
    return {
        restrict: "C", priority: 450, link: function (a, b) {
            var c = b.find(".mot-wid-menu-toggle-btn");
